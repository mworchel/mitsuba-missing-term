...
from mitsuba.ad.integrators.common import PSIntegrator, mis_weight

class PathProjectiveTempIntegrator(PSIntegrator):
    r"""
...
mi.register_integrator("prb_projective_temp", lambda props: PathProjectiveTempIntegrator(props))
